...
(
	EMPLOYEE_USERNAME   VARCHAR(15) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
...
(
	...
	EMPLOYEE_USERNAME   VARCHAR(15) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL UNIQUE,
...
(
	...
	WORK_PACKAGE    VARCHAR(5)    NOT NULL DEFAULT "",
...
INSERT INTO TES.CREDENTIALS VALUES('karan', 'password');
INSERT INTO TES.CREDENTIALS VALUES('ryan', 'password');
INSERT INTO TES.CREDENTIALS VALUES('test', 'password');
